...
namespace ACG_labs
{
    public static class Calculations
    {
        ...
        public static Vector3 LambertLight = new Vector3(3, 0, 0);//new Vector3(1, 1, (float)-Math.PI);
        ...
        public static Vector3 SelectedColor = new Vector3(0.5f, 0, 1);
        public static Vector3 BgColor = new Vector3(1);
        ...
        public static Vector3 CalculatePhong(float ka, Vector3 ia)
        {
            return ka * ia;
        }

        public static Vector3 CalculateSpecular(Vector3 normal, Vector3 view, Vector3 lightDir, float Ks, Vector3 Is)
        {
            ...
            float pow = (float)Math.Pow(Math.Abs(rv), Alpha);
            var part1 = Ks * pow;
        ...
        public static Color getColorFromV3(Vector3 v3)
        {
        ...
        public static Vector3 CalcPhongBgLight(float ka, Vector3 ia)
        {
            return ka * ia;
        }

        public static Vector3 CalcPhongDiffuseLight(Vector3 normal, Vector3 lightPosition, Vector3 id, float kd)
        {
            lightPosition = Vector3.Normalize(lightPosition);
            normal = Vector3.Normalize(normal);
            var dot = Vector3.Dot(normal, lightPosition);
        ...
        public static Vector3 CalcPhongMirrorLight(Vector3 normal, Vector3 view, Vector3 lightDir, float Ks, Vector3 Is)
        {
            var reflection = lightDir - 2 * Vector3.Dot(lightDir, normal) * normal;
            reflection = Vector3.Normalize(reflection);
